...
public class JwtUtil {
    ...
    @Value("${jwt.project-id:}")
    private String jwtProjectId;
    ...
    public boolean validateToken(String token) {
        try {
            ...
            if (StringUtils.hasText(jwtProjectId)) {
                String projectId = claims.get("project_id", String.class);
                if (!jwtProjectId.equals(projectId)) {
                    return false;
                }
            }
            //  토큰 만료 확인
